    ...
    return (
        ...
        <div className="menu">
            <div className='menuInner'>
                ...
                <button onClick={props.openPortfolio} className='menu-items'>
                    ...
                    &nbsp; Portfolio</button>
                <button onClick={props.openExp} className='menu-items'>
                ...
                <button onClick={props.openAbout} className='menu-items'>
                ...
                <button onClick={props.openContact} className='menu-items'>
